...
ET.SubElement(rels,'{%s}Relationship'%PR,{'Id':video_rid,'Type':'http://schemas.openxmlformats.org/officeDocument/2006/relationships/video','Target':'../media/acmot_v7_evidence.mp4'})
...
with tempfile.NamedTemporaryFile(prefix='acmot_v7_',suffix='.pptx',dir=PPTX.parent,delete=False) as f: tmp=Path(f.name)
